...
const button = tv({
  ...
  variants: {
    ...
    isDisabled: {
      true: "bg-gray-100 dark:bg-zinc-800 text-gray-300  hover:bg-gray-100 dark:hover:bg-zinc-800  dark:text-zinc-600 forced-colors:text-[GrayText] border-black/5 dark:border-white/5",
    },
  },
  defaultVariants: {
    variant: "primary",
